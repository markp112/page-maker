...
import { cssStyleTagTypesEnum } from '../enums/css-style-tag-types-enum';
...
export interface ILayout {
    ...
    styleTagType: cssStyleTagTypesEnum; // is this a css class or a standard html element being styled
